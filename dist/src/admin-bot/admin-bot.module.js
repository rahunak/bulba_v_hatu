...
exports.AdminBotModule = AdminBotModule = __decorate([
    (0, common_1.Module)({
        imports: [(0, common_1.forwardRef)(() => client_bot_module_1.ClientBotModule)],
        providers: [admin_bot_update_1.AdminBotUpdate, admin_bot_service_1.AdminBotService],
        exports: [admin_bot_service_1.AdminBotService],
    })
], AdminBotModule);
